...
mod tests {
    ...
    fn test_camel_case_identifier() {
        ...
        assert!(!is_camel_case_identifier("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"));
    ...
    fn test_snake_or_kebab_case() {
        ...
        assert!(!is_snake_or_kebab_case("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"));
    ...
    fn test_is_likely_code_identifier() {
        ...
        assert!(!is_likely_code_identifier("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"));
    ...
    fn test_detect_api_key() {
        ...
        let findings = detector.detect("API_KEY=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");
